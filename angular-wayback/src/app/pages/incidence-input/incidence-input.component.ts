...
import { ApiPathService } from 'src/app/shared/api-path.service';
...
export class IncidenceInputComponent {
    ...
    @ViewChild('incidence_type_id') incidence_type_id;
    ...
    constructor(
        ...
        public apiPathService: ApiPathService
    ) {
    ...
    sendEmail(body) {
        let url = this.apiPathService.apiPath + "/mailer"
    ...
    press(e) {
        if (e.keyCode === 13 && !e.shiftKey) {
            e.preventDefault();
            this.registerIncidence(this.incidence_ref.nativeElement.value, this.warehouse_id.nativeElement.value, this.incidence_type_id.nativeElement.value)
        }
    }
